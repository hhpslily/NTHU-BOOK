...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100" style="width:850px;">
			<form class="contact100-form validate-form" action='../../api/updateBookData.php' method='get'>
				...
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select required class="selection-2" name="b_status" id="b_status">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input id="name" class="input100" type="text" name="b_name" placeholder="Enter the book name (required)" required="required">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input id="imgInput" type="text" name="b_imgURL" style="visibility: hidden;" required="required">
				...
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select required class="selection-2" name="b_dept" id="Dept" onchange="changeDept(this)">
							<option value=""> --- </option>
						</select>
					</div>
					<span class="focus-input100"></span>
				...
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select required class="selection-2" name="b_courseID" id="Course" value="">
							<option value=""> --- </option>
						</select>
					</div>
					<span class="focus-input100"></span>
					...
					<div style="margin-top: 15px;">
						...
						<?php for($i = 1; $i <=10; $i++){ ?>
							<div class="radio_selection">
								<input class="level" type="radio" name="b_level" required="required" value="<?php echo $i ?>">
								<?php echo $i; ?>
							</div>
						<?php } ?>
				...
				<div class="wrap-input100 validate-input" data-validate="Price is required">
					...
					<input id="price" class="input100" type="text" name="b_price" placeholder="Enter the price (required)" required="required">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Message is required">
					<span class="label-input100">Note</span>
					<textarea id="note" class="input100" name="b_note" placeholder="Your message here..."></textarea>
					<span class="focus-input100"></span>
				</div>
	...
	<script type="text/javascript" src="/FinalProject/src/scripts/updateForm.js"></script>
