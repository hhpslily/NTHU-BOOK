...
Dialog.prototype.renderDialog = function (dialog, setAsFirst) {
    ...
    console.log("THIS IS AMERICA WOO ", app.userData);
    console.log("APP:" ,app);
    dialog.ownerID = localStorage.getItem(dialog.jidOrUserId);
    console.log(dialog.ownerID);
    ...
    QB.chat.dialog.create(params, function (err, createdDialog) {
        if (err) {
            ...
            _.each(occupants, function (occupantId) {
                console.log(userModule._cache, occupantId, userModule._cache[occupantId]);
            ...
            console.log("hi hi did it get here");
