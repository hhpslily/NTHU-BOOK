...
<head>
	...
	<script src="./scripts/quickblox.min.js" defer></script>
</head>
	...
	<script type="text/template" id="tpl_message">
		<div class="message__wrap" id="<%= message.id %>" data-status="<%= message.status %>">
			<span class="message__avatar m-user__img_<%= sender ? sender.color : 'not_loaded' %>">
				<img class="profile_pic" src="http://graph.facebook.com/<%= message.id %>/picture?type=square">
				<!-- <i class="material-icons">account_circle</i> -->
            </span>
...
<script type="text/template" id="tpl_attachmentPreview">
	...
	<script type="text/template" id="tpl_lost_connection">
		...
		<div class="spinner"><img src="./imgs/img/loader2.gif" alt="wating"></div>
	</script>

	<script type="text/template" id="tpl_loading">
		<div class="loading__wrapper">
			<div class="loading_inner">
				<img class="loading__logo" src="./imgs/img/qb-logo.svg" alt="QB_logo">
				<p class="loading__description">Loading...</p>
			</div>
		</div>
	</script>

	<script src="./scripts/js/index.js" defer></script>
	<script src="./scripts/js/QBconfig.js" defer></script>
	<script src="./scripts/js/user.js" defer></script>
	<script src="./scripts/js/dialog.js" defer></script>
	<script src="./scripts/js/message.js" defer></script>
	<script src="./scripts/js/listeners.js" defer></script>
	<script src="./scripts/js/helpers.js" defer></script>
	<script src="./scripts/js/app.js" defer></script>
	<script src="./scripts/js/login.js" defer></script>
	<script src="./scripts/js/route.js" defer></script>
